...
export default function HomePage() {
  ...
  const testimonials = [
    {
      ...
      role: "Patient",
      content:
        "The AI assistant made booking my appointment so easy! The doctors are incredibly professional and caring.",
      rating: 5,
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "For life-threatening emergencies, call 911. For urgent care, contact our 24/7 hotline at (555) 123-4567.",
    },
    {
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-4">
                <button
                  ...
                  className="text-gray-900 hover:text-emerald-600 px-3 py-2 rounded-md text-sm font-medium cursor-pointer"
                >
                  Home
                </button>
                <button
                  onClick={() => scrollToSection("services")}
                  className="text-gray-500 hover:text-emerald-600 px-3 py-2 rounded-md text-sm font-medium cursor-pointer"
                >
                  Services
                </button>
                <button
                ...
                {/* <Link href="/doctor/login">
                  <Button variant="outline" size="sm" className="border-emerald-600 text-emerald-600 hover:bg-emerald-600 hover:text-white bg-transparent">Doctor Login</Button>
                </Link> */}
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8">
                Experience world-class healthcare with our team of expert doctors and cutting-edge technology. Book
                appointments easily with our AI assistant and get the care you deserve.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button
                  variant="outline"
                  size="lg"
                  className="border-emerald-600 text-emerald-600 hover:bg-emerald-600 hover:text-white cursor-pointer bg-transparent"
                  onClick={() => scrollToSection("doctors")}
                >
            ...
            <div className="relative">
              <img src="/modern-medical-clinic.png" alt="Meera Clinic" className="rounded-lg shadow-2xl" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-16 bg-red-50 rounded-lg p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">
              24/7 emergency care available. For life-threatening emergencies, call 911.
            </p>
              ...
              <Card key={doctor.id} className="overflow-hidden hover:shadow-lg transition-shadow py-0">
                ...
                <CardContent className="p-6">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Link
                      href={`/chat?doctor=${doctor.id}&name=${encodeURIComponent(doctor.name)}&specialty=${encodeURIComponent(doctor.specialty)}`}
                    >
                      <Button
                        size="sm"
                        variant="outline"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                Founded in 2010, Meera Clinic has been at the forefront of providing exceptional healthcare services to
                our community. We combine traditional medical expertise with cutting-edge technology to deliver
                personalized care.
              </p>
              <p className="text-lg text-gray-600 mb-8">
                Our mission is to make quality healthcare accessible to everyone through innovative solutions like our
                AI-powered appointment system and comprehensive medical services.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-300 mb-4">
                Providing exceptional healthcare services with compassion and expertise since 2010.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <span className="text-gray-300">General Consultation</span>
                </li>
                <li>
                  <span className="text-gray-300">Specialist Care</span>
                </li>
                <li>
                  <span className="text-gray-300">Emergency Services</span>
                </li>
                <li>
                  <span className="text-gray-300">Health Checkups</span>
                </li>
                <li>
                  <span className="text-gray-300">Diagnostic Tests</span>
                </li>
              </ul>
            </div>
            <div>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center">
            <p className="text-gray-300">
              &copy; 2025 Meera Clinic. All rights reserved. | Privacy Policy | Terms of Service
            </p>
          </div>
        </div>
      </footer>
